  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10">
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-teal-700 opacity-10 rounded-full blur-3xl"></div>
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-teal-500 opacity-10 rounded-full blur-3xl"></div>
      </div>
